...
# Resumo para Área de Negócio (Stakeholder Summary)

**Adaptação BR.** Plugin adaptado ao Brasil. Resumo para área é entregável voltado a leitor não-jurídico — remova o cabeçalho de sigilo profissional (EOAB art. 7º, XIX) só ao encaminhar fora do círculo, e sanitize jargão (LGPD em vez de GDPR; indenização CC 944 explicada em português comum; cláusula penal CC 408–416; etc.).
...
Read `~/.claude/plugins/config/claude-for-legal/comercial/CLAUDE.md` → `## House style` → who reads stakeholder summaries, how long should they be. If not specified, default to: procurement or a department head, two paragraphs max, no legal terms of art.

Different audiences need different summaries:

| Audiência | Importa | Não importa |
|---|---|---|
| **Compras / Procurement** | Preço, mecânica de renovação, rota de aprovação | Estrutura do cap de responsabilidade |
| **Líder da área (dono do orçamento)** | A equipe pode usar, o que acontece se quebra, custo | Escopo de indenização |
| **Financeiro / Controladoria** | Custo total, risco de reajuste, compromissos off-balance | Lei aplicável |
| **Segurança / TI / DPO** | Tratamento de dados (LGPD), subprocessadores, ISO 27001/SOC 2, onde os dados ficam, transferência internacional | Resto |
| **Sponsor executivo** | Isto vai nos constranger, o jurídico é gargalo | Detalhes |

Pergunte para quem é se não estiver óbvio.
...
| Achado jurídico | Tradução para negócio |
|---|---|
| "Responsabilidade limitada a 12 meses de fees (CC art. 944)" | "Se eles estragarem alguma coisa, o máximo que conseguimos recuperar é o equivalente a um ano do que pagamos a eles." |
| "Sem rescisão imotivada" | "Depois que assinarmos, ficamos presos pelo prazo cheio — não dá para sair só porque paramos de usar." |
| "Renovação automática com aviso de 60 dias" | "Renova sozinho todo ano. Para cancelar, temos que avisar dois meses antes da data de renovação." |
| "Sem indenização por PI" | "Se alguém nos processar dizendo que esta ferramenta viola patente/marca, o fornecedor não cobre nossa defesa." |
| "Lista de subprocessadores não divulgada (LGPD)" | "Não sabemos quais outras empresas terão acesso aos nossos dados via eles. Risco LGPD." |
| "Exclusão de dados em 30 dias após rescisão (LGPD art. 16)" | "Quando cancelarmos, eles apagam nossos dados em um mês. Exporte o que precisar antes." |
| "Crédito de SLA limitado a 10% da mensalidade" | "Se cair, recebemos um créditozinho de volta. Não cobre o custo da indisponibilidade para o negócio." |

### O que NÃO incluir

- Números de seção
- Termos definidos em aspas
- A palavra "indenização" (diga "eles nos cobrem se..." / "nós cobrimos eles se...")
- A palavra "não obstante" / "não obstante o disposto"
- Matrizes de risco com bolinhas coloridas (salvo se a área já pediu antes)
- Ressalvas de que isto não é parecer jurídico — o(a) destinatário(a) sabe quem mandou
...
**To the stakeholder:** Via whatever channel `~/.claude/plugins/config/claude-for-legal/comercial/CLAUDE.md` says. If Slack, keep it under 150 words. If email, the format above is fine as-is.
